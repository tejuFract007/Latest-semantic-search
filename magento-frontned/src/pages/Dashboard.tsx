...
//       description: "Use natural language to query your product database",
//       icon: Brain,
//       path: "/ai-query",
...
//       description: "Filter products by brand, category, price, and more",
//       icon: Search,
//       path: "/search",
...
//       description: "Load and manage Magento data with ease",
//       icon: Database,
//       path: "/data",
...
//           Magento AI Catalog Dashboard
//         </h1>
//         <p className="text-xl text-gray-600 max-w-2xl mx-auto">
//           Intelligent product search and analytics powered by AI. Transform your
//           Magento data into actionable insights.
//         </p>
//       </div>
...
//                       {feature.title}
//                     </h3>
//                     <ArrowRight className="h-5 w-5 text-gray-400 group-hover:text-primary-600 transform group-hover:translate-x-1 transition-transform" />
//                   </div>
