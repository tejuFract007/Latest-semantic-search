...
//       id: "categories",
//       title: "Categories",
//       description: "Load category hierarchy from categories-tree.json",
//       icon: Database,
...
//       id: "attributes",
//       title: "Attributes",
//       description: "Load product attributes from attribute-master.json",
//       icon: Database,
...
//       id: "products",
//       title: "Products",
//       description: "Process and load products from Magento NDJSON file",
//       icon: Upload,
...
//       id: "all",
//       title: "Load All Data",
//       description: "Load categories, attributes, and products in sequence",
//       icon: RefreshCw,
...
//             Load and manage your Magento catalog data
//           </p>
//         </div>
//       </div>
...
//             </div>
//             <p className="text-gray-600">Products Loaded</p>
//           </div>
//           <div className="card text-center">
//             <div className="text-2xl font-bold text-gray-900 mb-2">
...
//           return (
//             <div key={dataType.id} className="card">
...
//                         <span>
//                           {result.processed
//                             ? `${result.message} (${result.processed} processed)`
//                             : result.message}
//                         </span>
//                       </div>
//                     )}
...
//           <p>
//             <strong>1. Categories:</strong> Loads the category hierarchy from
//             categories-tree.json
//           </p>
//           <p>
//             <strong>2. Attributes:</strong> Loads attribute definitions from
//             attribute-master.json
//           </p>
//           <p>
//             <strong>3. Products:</strong> Processes the Magento NDJSON file and
//             loads products into the database
//           </p>
//           <p>
//             <strong>4. Load All:</strong> Runs all three steps in sequence
//           </p>
//           <p className="text-xs text-gray-500 mt-4">
//             Note: Make sure your data files are placed in the backend/data/
//             directory
//           </p>
//         </div>
//       </div>
